...
from geprofiler.frame import BaseFrame, DummyFrame, Frame, SelfTimeFrame
from geprofiler.typing import PathOrStr

# pyright: strict


ASSERTION_MESSAGE = (
    "Please raise an issue at https://github.com/joerick/geprofiler/issues and "
...
class Session:
    def __init__(
        ...
        program: str,
        cpu_time: float,
        url: str = "",  # used with http server like Django
    ):
        """Session()
